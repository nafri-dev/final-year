          ...
          <div className="flex items-center space-x-4 ">
            {user ? (
              <div className="hidden md:flex items-center space-x-4 ">
                ...
                <button onClick={logout} className="text-primary hover:text-primary-dark">
                  Logout
                </button>
              </div>
            ) : (
        ...
        {isMenuOpen && (
          <nav className="mt-4 md:hidden">
            <div className="flex flex-col space-y-2">
              <Link to="/" className="text-gray-600 hover:text-gray-900 py-2" onClick={toggleMenu}>Home</Link>
              <Link to="/products" className="text-gray-600 hover:text-gray-900 py-2" onClick={toggleMenu}>Products</Link>
              <Link to="/Aboutus" className="text-gray-600 hover:text-gray-900 py-2" onClick={toggleMenu}>About Us</Link>
              {!user && (
                <>
                  <Link to="/login" className="text-gray-600 hover:text-gray-900 py-2" onClick={toggleMenu}>Login</Link>
                  <Link to="/register" className="text-gray-600 hover:text-gray-900 py-2" onClick={toggleMenu}>Register</Link>
                </>
              )}
            </div>
          </nav>
